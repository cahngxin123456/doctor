//
//  IWBloodSugerDataViewController.m
//  Doctor
//
...
@interface IWBloodSugerDataViewController ()<UITableViewDelegate,UITableViewDataSource,MJRefreshBaseViewDelegate>


@property (nonatomic, strong) MJRefreshFooterView *header;
...
@implementation IWBloodSugerDataViewController
...
//- (void)loadMoreData {
//    // 计算当前的页码
//    double number = [self.totalCount doubleValue]/ IWPAGESIZE;
//    IWLog(@"%f", number);
...
//    //血压
//    [IWHttpTool postWithURL:SERVER_GET_BLOOD_SUGAR_LIST_URL params:params success:^(id json) {
//        
...
//            self.totalCount = tempDic[@"totalCount"];
